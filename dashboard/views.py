...
def homework(request):
    if request.method == 'POST':
        ...
        if form.is_valid():
            ...
            homeworks.save()
            messages.success(request, f'Homework is added by {request.user.username} successfully')
    else:
        form = HomeworkForm()
...
# There is little errror in this section, check this -> can't able to find all the words here and synonyms is not
# working as well 
...
def register(request):
    if request.method == 'POST':
        ...
        if form.is_valid():
            ...
            messages.success(request, f'Account has beeen successfully created for {username}')
